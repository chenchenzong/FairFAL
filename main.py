...
from util.longtail_dataset import IMBALANCECIFAR10, IMBALANCECIFAR100, IMBALANCEFashionMNIST
from util.misc import adjust_learning_rate


def get_dataset(args):
    MEAN = {'fmnist': (0.286,), 'cifar10': [0.485, 0.456, 0.406], 'cifar100': [0.507, 0.487, 0.441], 'octmnist': (0.5,), 'dermamnist': (0.5,)}
    STD = {'fmnist': (0.353,), 'cifar10': [0.229, 0.224, 0.225], 'cifar100': [0.267, 0.256, 0.276], 'octmnist': (0.5,), 'dermamnist': (0.5,)}
    ...
    elif args.dataset == 'fmnist_lt':
        dataset_train = IMBALANCEFashionMNIST('train', args.imb_ratio, args.data_dir)
        dataset_query = IMBALANCEFashionMNIST('train', args.imb_ratio, args.data_dir, train_aug=False)
        dataset_test = IMBALANCEFashionMNIST('test', args.imb_ratio, args.data_dir)
    ...
    # medical benchmarks
    elif args.dataset in ['octmnist', 'dermamnist']:
    ...
    print("total data num is ", args.total_data)
...
if __name__ == '__main__':
    ...
    while round(args.current_ratio, 2) <= args.end_ratio:
        ...
        if args.query_ratio == args.current_ratio:
            ...
            dict_users_train_label, mean_global_ratio = algo_query_samples(dataset_train, dataset_query, dataset_test, dict_users_train_total, dict_users_test_total, mean_global_ratio, args)
