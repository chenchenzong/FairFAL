...
class IMBALANCEFashionMNIST(datasets.FashionMNIST):
    cls_num = 10

    def __init__(self, phase, imbalance_ratio, root='data/fmnist_lt/', imb_type='exp', train_aug=True):
        train = True if phase == 'train' else False
        super(IMBALANCEFashionMNIST, self).__init__(root, train, transform=None, target_transform=None, download=True)
        self.train = train
